...
uint64_t uniffi_shared_fn_clone_coreffi(uint64_t handle, RustCallStatus *_Nonnull out_status
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_SHARED_FN_FREE_COREFFI
#define UNIFFI_FFIDEF_UNIFFI_SHARED_FN_FREE_COREFFI
void uniffi_shared_fn_free_coreffi(uint64_t handle, RustCallStatus *_Nonnull out_status
);
#endif
...
uint64_t uniffi_shared_fn_constructor_coreffi_new(RustCallStatus *_Nonnull out_status
    
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_SHARED_FN_METHOD_COREFFI_RESOLVE
#define UNIFFI_FFIDEF_UNIFFI_SHARED_FN_METHOD_COREFFI_RESOLVE
RustBuffer uniffi_shared_fn_method_coreffi_resolve(uint64_t ptr, uint32_t id, RustBuffer data, RustCallStatus *_Nonnull out_status
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_SHARED_FN_METHOD_COREFFI_UPDATE
#define UNIFFI_FFIDEF_UNIFFI_SHARED_FN_METHOD_COREFFI_UPDATE
RustBuffer uniffi_shared_fn_method_coreffi_update(uint64_t ptr, RustBuffer data, RustCallStatus *_Nonnull out_status
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_SHARED_FN_METHOD_COREFFI_VIEW
#define UNIFFI_FFIDEF_UNIFFI_SHARED_FN_METHOD_COREFFI_VIEW
RustBuffer uniffi_shared_fn_method_coreffi_view(uint64_t ptr, RustCallStatus *_Nonnull out_status
);
#endif
