...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_shared__ffi_checksum_method_coreffi_resolve() != 49197) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_shared__ffi_checksum_method_coreffi_update() != 54109) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_shared__ffi_checksum_method_coreffi_view() != 47914) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_shared__ffi_checksum_constructor_coreffi_new() != 17131) {
        return InitializationResult.apiChecksumMismatch
    }

    uniffiEnsureSharedFfiInitialized()
